...
public class PCFBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements PCFVisitor<T> {
	 ...
	 */
	@Override public T visitTerm(PCFParser.TermContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitIfzExp(PCFParser.IfzExpContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
